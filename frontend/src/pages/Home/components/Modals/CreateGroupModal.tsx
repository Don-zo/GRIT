        ...
        <Modal.Body className="flex flex-col items-center pb-6">
          ...
          <div className="mx-auto mt-6 w-full max-w-[320px]">
            ...
            <button
              ...
              className="mt-3 h-12 w-full rounded-lg bg-[#3E7358] text-base font-semibold text-[#EDFFF4] hover:bg-emerald-800 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          {inviteCode && (
            <div className="mt-4 flex items-center gap-1 rounded-xl bg-white px-3 py-1.5">
